...
namespace AuroraScienceHub.Integrations.UnitTests.Noaa.Ace;
...
{
    [Theory]
    [EmbeddedResourceData("AuroraScienceHub.Integrations.UnitTests.Noaa/Ace/Samples/AceMagnetometerSample.txt")]
